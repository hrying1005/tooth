...
if __name__ == "__main__":
    ...
    dataset_config = {
        ...
        'own': {
            'root_path': '/content/drive/MyDrive/MyTransunet/code/TransUNet/data/GLASS/',
            'list_dir': '',
            'num_classes': 2,
        },
    }
    ...
    snapshot_path = "/content/drive/MyDrive/MyTransunet/code/TransUNet/model/{}/{}".format(args.exp, 'TU')
