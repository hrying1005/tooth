...
from datasets.my_data import ImageFolder
...
def inference(args, model, test_save_path=None):
    ...
    performance_exist = (metric_list[:,0] != 0)
    performance = metric_list.sum() / performance_exist.sum()
    mean_hd95_exist = (metric_list[:,1] != 0)
    mean_hd95 = metric_list.sum() / mean_hd95_exist.sum()
...
if __name__ == "__main__":
    ...
    dataset_config = {
        ...
        'own': {
            'Dataset': ImageFolder,
            'root_path': '/home/datadev/hry/code/myTransUNet/TransUNet/data/GLASS/',
            'volume_path': '/home/datadev/hry/code/myTransUNet/TransUNet/data/GLASS/',
            'list_dir': '',
            'num_classes': 2,
            'z_spacing': 1,
        },
    ...
    snapshot_path = "/home/datadev/hry/code/myTransUNet/TransUNet/model/{}/{}".format(args.exp, 'TU')
    ...
    log_folder = '/home/datadev/hry/code/myTransUNet/TransUNet/TransUNet/test_log/test_log_' + args.exp
    ...
    if args.is_savenii:
        args.test_save_dir = '/home/datadev/hry/code/myTransUNet/TransUNet/predictions'
